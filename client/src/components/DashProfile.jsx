  ...
  return (
    <div className="max-w-lg mx-auto p-3 w-full">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        onClick={() => filePckerRef.current.click()}
        >
          {imageFileUploadingProgress && (
           ...
           styles={{
            ...
            path: {
              stroke: `rgba(62, 231, 218, ${imageFileUploadingProgress / 100})`,
            }
           }} />
          )} 
      ...
      >
        ...
        <Modal.Body>
          ...
          <div className="flex justify-center gap-4" >
            <Button color='failure' onClick={handleDeleteUser}>Yes, am Sure</Button>
            <Button color='success' onClick={() => setShowModal(false)}>Cancel</Button>
          </div>
          </div>
